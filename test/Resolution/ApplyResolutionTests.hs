...
test3 = applyResolution clause1 clause5 (literal1, literal2, sub) == []
test4 = applyResolution clause6 clause3 (literal3, literal4, sub) == []
test5 = applyResolution clause7 clause5 (literal1, literal2, sub) == [ Pos(R("Q", [Fn("A", [])]))]
test6 = applyResolution clause7 clause8 (literal3, literal4, sub) == [Pos(R("P", [Var "Z"])), Neg(R("P", [Var "Z"])), Pos(R("P", [Var "Z"])), Neg(R("P", [Var "Z"]))]
test7 = applyResolution clause9 clause10 (literal3, literal4, sub) == [Neg(R("P", [Var "Z"])), Pos(R("P", [Var "Z"]))]
test8 = applyResolution clause10 clause11 (literal3, literal4, sub) == [Pos(R("P", [Var "Z"])), Pos(R("P", [Var "Z"])), Neg(R("P", [Var "Z"]))]
